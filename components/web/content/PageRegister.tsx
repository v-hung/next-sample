...
import { register } from "@/actions/web/user"
        ...
        >
          <div className="px-6 py-8">
            ...
            <div className="mt-6 flex flex-col space-y-4">
              <InputAdmin name='email' label="Tài khoản" required />
              <InputAdmin name='name' label="Tên tài khoản" required />
            
              <PasswordInputAdmin name='password' label="Mật khẩu" required />

              { error ? <div className="p-2 rounded border-red-300 bg-red-100 text-red-500">{error}</div> : null }
              <ButtonAdmin type='submit'>Đăng ký</ButtonAdmin>
